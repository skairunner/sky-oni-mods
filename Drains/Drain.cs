namespace Drains
{
    ...
    public class Drain : KMonoBehaviour, ISim1000ms
    {
        ...
        protected override void OnSpawn()
        {
            ...
            this.dispenser.GetConduitManager().AddConduitUpdater(new System.Action<float>(this.OnConduitUpdate),
        ...
        {
            this.selectable.ToggleStatusItem(Db.Get().BuildingStatusItems.ConduitBlocked,
                (double) this.dispenser.ConduitContents.mass > 0.0, (object) null);
        }

        public ConduitType conduitType
        {
            get { return this.dispenser.conduitType; }
        }
    }
}